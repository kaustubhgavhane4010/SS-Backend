...
import { Plus, Users, Building, BarChart3, UserPlus, Building2, X, Edit, Trash2, Shield, Crown } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [statsRes, orgsRes, usersRes] = await Promise.all([
        api.get('/organizational/admin-stats'),
        api.get('/organizational/admin-organizations'),
        api.get('/organizational/admin-users')
      ]);
  ...
  const handleCreateUser = async () => {
    ...
    try {
      const response = await api.post('/organizational/admin-users', newUser);
  ...
  const handleCreateOrganization = async () => {
    try {
      const response = await api.post('/organizational/admin-organizations', newOrganization);
      if (response.data?.success) {
  ...
  const handleDeleteOrganization = async (orgId: string | number) => {
    ...
    if (confirm('Are you sure you want to delete this organization? This action cannot be undone.')) {
      try {
        console.log('Making delete request to:', `/organizational/admin-organizations/${orgId}`);
        const response = await api.delete(`/organizational/admin-organizations/${orgId}`);
  ...
  const handleDeleteUser = async (userId: string | number) => {
    ...
    if (confirm('Are you sure you want to delete this user? This action cannot be undone.')) {
      try {
        console.log('Making delete request to:', `/organizational/admin-users/${userId}`);
        const response = await api.delete(`/organizational/admin-users/${userId}`);
        console.log('Delete response:', response);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage your organizations and users within your scope</p>
        <div className="mt-2 flex items-center gap-2 text-sm text-blue-600">
          <Crown className="h-4 w-4" />
          <span>Admin Level Access - Can create University Admin, Senior Leadership, Dean, Manager, and Team Member roles</span>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">My Organizations</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">My Users</p>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">User Role Distribution (My Scope)</h3>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Recent Users (My Scope)</h3>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg leading-6 font-medium text-gray-900">My Organizations</h3>
              <button 
      ...
      {currentTab === 'users' && (
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg leading-6 font-medium text-gray-900">My Users</h3>
              <button 
          ...
          <div className="relative bg-white p-8 border border-gray-300 rounded-lg shadow-xl w-full max-w-md max-h-full">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Admin can create roles below Admin level only</p>
              </div>
              <div>
